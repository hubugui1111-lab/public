...
uint8_t route_gc(FPMath&math,OTPack&ot,const std::array<uint8_t,15>&share,uint8_t leaf_mask){
...
int main(int argc,char**argv){
  ...
  uint8_t masked=route_gc(math,ot,local,mask);
  ...
  std::cout<<"EXP207R_RESULT party="<<party
           <<" bytes="<<bytes<<" rounds="<<rounds<<" ms="<<ms
